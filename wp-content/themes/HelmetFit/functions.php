...
function theme_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('helmetfit_themescripts', get_template_directory_uri() . '/scripts.js', array('jquery'), '1.0.0'); // Custom scripts
        wp_enqueue_script('helmetfit_themescripts'); // Enqueue it!
    }
}
/* Enqueue Scripts */
...
function theme_style()
{
  ...
  // FONTS CSS
  wp_register_style('helmetfitfonts', get_template_directory_uri() . '/fonts/fonts.css', array(), '1.0', 'all');
    wp_enqueue_style('helmetfitfonts'); // Enqueue it!
  ...
  wp_register_style('SlickTheme', get_template_directory_uri() . '/css/slick-theme.css', array(), '1.0', 'all');
    ...
    wp_register_style('fug-styles', get_template_directory_uri() . '/fug-style.css', array(), '1.0', 'all');
    wp_enqueue_style('fug-styles'); // Enqueue it!
}
...
// ADD CUSTOM POST TYPES (All Contained in single function)
 ...
 add_action('init', 'add_testimonials_taxonomies');
...
function add_testimonials_taxonomies()
{
    $labels = array(
                'name'            => 'Types',
        'singular_name'        => 'Type',
    ...
    register_taxonomy('testimonial-type', array('testimonials'), $args);
}
...
{
    echo '<span id="footer-thankyou">Made with love by <a target="_blank" href="http://www.agilecat.com">AgileCat</a></span>';
}
...
function vid_unautop($pee2)
{
    $pee2 = preg_replace('/<p>\\s*?(<a .*?><iframe.*?><\\/a>|<iframe.*?>)?\\s*<\\/p>/s', '<div class="post-vid"><div class="post-vid-wrap">$1</div></div>', $pee2);
    return $pee2;
}
add_filter('the_content', 'vid_unautop', 30);
...
/* Add a Dashboard Message Helper */
...
function hints_tips_widget()
{
    ...
    wp_add_dashboard_widget('custom_help_widget', 'HelmetFit WordPress Cheatsheet', 'custom_hints_tips');
}

function custom_hints_tips()
{
    echo '
<h2>HelmetFit Wordpress Guide</h2>
<i>Click on the link below to access your guide.</i></br>

    <ul>
    <li><h3><a style="text-decoration:none;" href="https://www.dropbox.com/sh/eu0btp4e393h6hi/AADRZXBMDpYXfiQy93MuzH-Ka?dl=0" target="_blank">HelmetFit Wordpress Guide</a></h3></li>
    </ul>

    <h2>Code Tips</h2>
    <ul>
    <li><b>Embed Slider to Blog Post: </b>[post_gallery]</li>
    <li><b>Add Contact Button:</b> <br />
    &lt;a class="button" href="mailto:sales@helmitfit.com" target="_blank" rel="noopener noreferrer">Contact Us&lt;/a&gt;</li>
    </ul>

<h2>Recommended Image Sizes</h2>

<ul>
<li><b>Hero Images:</b></li>
<li><b>Helmet Safety Blog Image: 1200 x 675</b></li>
<li><b>Blog Slider Images:</b> 800 x 500</li>
<li><b>Homepage Featured Images:</b> 340 x 470</li>
<li><b>Testimonial Headshot:</b> 265 x 275</li>
<li><b>Parallax:</b> 1200 x 600</li>
</ul>';
}
